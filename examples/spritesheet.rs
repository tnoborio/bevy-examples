...
fn setup(
    ...
    let order = vec![
        ...
        layout.add_texture(URect::from_corners(
            UVec2::new(146, 0),
            UVec2::new(72 + 146, 97 + 0),
        )),
        layout.add_texture(URect::from_corners(
            UVec2::new(0, 98),
            UVec2::new(72 + 0, 97 + 98),
        )),
        layout.add_texture(URect::from_corners(
            UVec2::new(73, 98),
            UVec2::new(72 + 73, 97 + 98),
        )),
        layout.add_texture(URect::from_corners(
            UVec2::new(146, 98),
            UVec2::new(72 + 146, 97 + 98),
        )),
        layout.add_texture(URect::from_corners(
            UVec2::new(219, 0),
            UVec2::new(72 + 219, 97 + 0),
        )),
        layout.add_texture(URect::from_corners(
            UVec2::new(292, 0),
            UVec2::new(72 + 292, 97 + 0),
        )),
        layout.add_texture(URect::from_corners(
            UVec2::new(219, 98),
            UVec2::new(72 + 219, 97 + 98),
        )),
        layout.add_texture(URect::from_corners(
            UVec2::new(365, 0),
            UVec2::new(72 + 365, 97 + 0),
        )),
        layout.add_texture(URect::from_corners(
            UVec2::new(292, 98),
            UVec2::new(72 + 292, 97 + 98),
        )),
    ];
